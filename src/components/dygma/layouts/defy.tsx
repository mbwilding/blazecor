 ...
 * Copyright (C) 2025  Matthew Wilding
 *
...
export class LayoutDefy extends React.Component<DefyProps, DefyState> {
    ...
    render() {
        ...
        const stroke = (row: number, col?: number) => (isSelected(row, col) ? (this.props.darkMode ? "#fff" : "#000") : "#b3b3b3");
        ...
        const getDivideKeys = (str: string, xCord: number, yCord: number, smallKey: boolean = false) => {
            ...
            if (numbers) {
                return (
                    <GetCurrentKeyElement key={randomKey} x={xCord} y={+yCord - 5} word={str} class="key-config" />
                );
            }
