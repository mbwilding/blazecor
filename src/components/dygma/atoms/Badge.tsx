    ...
    "inline-flex items-center rounded-[3px] border-[1px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:focus:ring-slate-300",
    {
        variants: {
            variant: {
                ...
                danger: "border-[1px] border-solid bg-primary/15 border-primary/15 text-primary/75 dark:bg-primary/30 dark:text-gray-50 dark:text-gray-25",
                success: "border-[1px] border-solid text-green-200 border-green-200 bg-green-200/15",
                subtle: "border-[1px] border-solid border-gray-50 bg-gray-50 text-gray-400 dark:text-gray-100 dark:border-gray-700 dark:bg-gray-700",
                warning:
