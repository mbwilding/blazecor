    ...
    "relative flex w-full touch-none select-none items-center py-4 [&_.track]:relative [&_.track]:h-2 [&_.track]:w-full [&_.track]:grow [&_.track]:overflow-hidden [&_.track]:rounded-full [&_.range]:absolute [&_.range]:h-full group",
    {
        variants: {
            variant: {
                ...
                alert: "[&_.track]:bg-gray-50 [&_.track]:dark:bg-gray-400 [&_.range]:bg-primary/100 [&_.range]:dark:bg-primary/100 [&_.thumb]:shadow-[0_4px_12px_0px_rgba(254,0,124,0.9)] [&_.thumb]:border-gray-25 [&_.thumb]:bg-primary/100 [&_.thumb]:dark:bg-primary/100",
            },
        },
        defaultVariants: {
            variant: "default",
