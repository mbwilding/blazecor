        ...
        <div>
            <div className="batterySideWrapper">
                <div className="batterySide relative">
                    {side === "left" ? (
                        <DefyBatteryIndicatorLeft batteryStatus={batteryStatus} batteryHeight={batteryHeight} />
                    ) : (
                        ""
                    )}
                    {side === "right" ? (
                        <DefyBatteryIndicatorRight batteryStatus={batteryStatus} batteryHeight={batteryHeight} />
                    ) : (
                        ""
                    )}
                    {batteryStatus === 0 ? (
