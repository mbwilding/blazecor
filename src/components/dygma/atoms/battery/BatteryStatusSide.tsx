        ...
        <div>
            ...
            >
                <div className="battery-item--container flex gap-2 items-center" style={{ color: "var(--color-status)" }}>
                    {size === "sm" ? (
                        <div className="battery-indicator--side text-gray-400 text-[0.5rem] font-semibold uppercase">
                            {sideFirstLetter}
                        </div>
                    ) : (
                        ""
                    ...
                    {size === "lg" ? (
                        <DefyBatteryIndicator side={side} batteryLevel={batteryLevel} batteryStatus={batteryStatus} />
                    ) : (
                        ""
                    )}
                </div>
