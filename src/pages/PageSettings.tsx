      ...
      <AccordionItem value="keymap">
        ...
        <AccordionContent>
          ...
          <div>
            ...
            <Input
              value={settings.keymapCustom.join(',')}
            />
          </div>
          {/* keymapDefault */}
          <div>
            ...
            <Input
              value={settings.keymapDefault.join(',')}
            />
          </div>
          {/* keymapOnlyCustom */}
          <div>
            ...
            <Switch
              checked={settings.keymapOnlyCustom}
            />
          </div>
          ...
          <div>
            ...
            <Input
              type="number"
              value={settings.settingsDefaultLayer}
            />
          </div>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="superkeys">
        ...
        <AccordionContent>
          ...
          <div>
            ...
            <Input
              value={settings.superkeysMap.join(',')}
            />
          </div>
          {/* superkeysWaitFor */}
          <div>
            ...
            <Input
              type="number"
              value={settings.superkeysWaitFor}
            />
          </div>
          {/* superkeysTimeout */}
          <div>
            ...
            <Input
              type="number"
              value={settings.superkeysTimeout}
            />
          </div>
      ...
      <AccordionItem value="led">
        ...
        <AccordionContent>
          ...
          <div>
            ...
            <Select
              value={settings.ledMode.toString()}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Slider
              value={[settings.ledBrightnessKeysWired]}
              max={255}
            />
          </div>
      ...
      <AccordionItem value="wireless">
        ...
        <AccordionContent>
          ...
          <div>
            ...
            <Switch
              checked={settings.wirelessBatterySavingMode || false}
            />
          </div>
          ...
          <div>
            ...
            <Select
              value={
                settings.wirelessRfPowerLevel !== undefined
                  ? settings.wirelessRfPowerLevel.toString()
                  : ''
              }
            >
              <SelectTrigger>
